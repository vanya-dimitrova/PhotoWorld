package com.example.user.photoworld.category;
...
import com.example.user.photoworld.gallery.PhotoViewActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.MyViewHolder2> {

    private List<Photo> categoryPhotos;
    private final Context context;

    public CategoryAdapter(Context context, List<Photo> categoryPhotos){
