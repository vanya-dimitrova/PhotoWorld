...
import static com.example.user.photoworld.login.HomeActivity.gallery;
...
public class CategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryPhotos = HomeActivity.gallery.photos.get(category);

        CategoryAdapter adapter2 = new CategoryAdapter(CategoryActivity.this, categoryPhotos);
